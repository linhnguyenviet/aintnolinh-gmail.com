...
import OverviewTrussReport from './overview'
import DetailsTrussReport from './details'
...
export default class TrussReport extends Component {
    constructor(props) {
        super(props);
        this.state = { ...buttons };
    ...
    render() {
        return (
            <div className="overall-report">
                ...
                {
                    this.state.overview_report ? <OverviewTrussReport /> : this.state.details_report ? <DetailsTrussReport /> : null
                }
            </div>
        )
    }
