...
import OverviewColumnsReport from './overview'
import DetailsColumnsReport from './details'
const buttons = {
    overview_report: false,
    details_report: false,
}

export default class ColumnsReport extends Component {
    constructor(props) {
        super(props);
        this.state = { ...buttons };
    ...
    render() {
        return (
            <div className="overall-report">
                ...
                {
                    this.state.overview_report ? <OverviewColumnsReport /> : this.state.details_report ? <DetailsColumnsReport /> : null
                }
            </div>
        )
    }
