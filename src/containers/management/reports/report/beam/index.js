...
import OverviewBeamReport from './overview'
import DetailsBeamReport from './details'
const buttons = {
    overview_report: false,
    details_report: false,
}

export default class BeamReport extends Component {
    constructor(props) {
        super(props);
        this.state = { ...buttons };
    ...
    render() {
        return (
            <div className="overall-report">
                ...
                {
                    this.state.overview_report ? <OverviewBeamReport /> : this.state.details_report ? <DetailsBeamReport /> : null
                }
            </div>
        )
    }
