...
import OverviewPrimaryGirder from './overview'
import DetailsPrimaryGirder from './details'
...
export default class PrimaryGirderReport extends Component {
    constructor(props) {
        super(props);
        this.state = { ...buttons };
    ...
    render() {
        return (
            <div className="overall-report">
                ...
                {
                    this.state.overview_report ? <OverviewPrimaryGirder /> : this.state.details_report ? <DetailsPrimaryGirder /> : null
                }
            </div>
        )
    }
