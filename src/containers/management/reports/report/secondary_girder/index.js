...
import OverviewSecondaryGirder from './overview'
import DetailsSecondaryGirder from './details'
...
export default class SecondaryGirderReport extends Component {
    constructor(props) {
        super(props);
        this.state = { ...buttons };
    ...
    render() {
        return (
            <div className="overall-report">
                ...
                {
                    this.state.overview_report ? <OverviewSecondaryGirder /> : this.state.details_report ? <DetailsSecondaryGirder /> : null
                }
            </div>
        )
    }
