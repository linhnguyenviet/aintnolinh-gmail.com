...
import OverviewSecondaryColumn from './overview'
import DetailsSecondaryColumn from './details'
...
export default class SecondaryColumnsReport extends Component {
    constructor(props) {
        super(props);
        this.state = { ...buttons };
    ...
    render() {
        return (
            <div className="overall-report">
                ...
                {
                    this.state.overview_report ? <OverviewSecondaryColumn /> : this.state.details_report ? <DetailsSecondaryColumn /> : null
                }
            </div>
        )
    }
