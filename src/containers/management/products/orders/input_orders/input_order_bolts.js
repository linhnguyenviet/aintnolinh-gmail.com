...
import { postBoltOrder } from "../../../../../actions/order";

class InputOrderBolts extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  handleClickOk = () => {
    ...
    this.props.postBoltOrder({
      ...
      quantity_box: Number(quantity_box),
  ...
  render() {
    ...
    const dataBoltOrder = listBoltOrderPost.filter(
      boltOrder => {
        if (boltOrder.id) {
...
const mapDispatchToProps = dispatch => ({
  ...
  postBoltOrder: bolt => dispatch(postBoltOrder(bolt))
});
...
const mapStateToProps = state => ({
  ...
  listBoltOrderPost: state.orderReducer.listBoltOrderPost
});
export default connect(mapStateToProps, mapDispatchToProps)(InputOrderBolts);
