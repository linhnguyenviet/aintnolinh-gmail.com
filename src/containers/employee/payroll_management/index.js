            ...
            <div className="payroll-management">
                <div className="top-content">
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                <td><span>Số nhân viên</span></td>
                                {rowbody}
                            </tr>
                            <tr>
                                <td><span>Thời gian lao động</span></td>
                                {rowbody}
                            </tr>
                            <tr>
                                <td><span>Thời gian tăng ca</span></td>
                                {rowbody}
                            </tr>
                            <tr>
                                <td><span>Thời gian lao động trung bình</span></td>
                                {rowbody}
                            </tr>
                            <tr>
                                <td><span>Tổng số tiền chi trả</span></td>
                                {rowbody}
                            </tr>
